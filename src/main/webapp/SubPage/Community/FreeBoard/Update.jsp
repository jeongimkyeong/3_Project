...
<div class="smain">
       ...
       %> 
        ...
        <div class="content">
            ...
            <div class="scont">
            	<form name="updateFrm" method="post" action="/board/update.do">
            	<!-- 게시글 리스트 -->
                <table class="ftbl" style="width: 830px;">
                    ...
                    <tbody>
                    	<tr>
                            <th>제목</th>
                            <td>
                            <input name="subject" type="text" value="<%=dto.getSubject() %>" style="width:500px;height:34px;line-height:34px;border:1px solid #ddd;" >
                            </td>
                        </tr>
                        <tr>
                            <th>글쓴이</th>
